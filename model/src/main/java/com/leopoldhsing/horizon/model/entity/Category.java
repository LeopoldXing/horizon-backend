...
public class Category extends BaseEntity {
    ...
    public Category(String id, Date createdAt, Date updatedAt, String createdBy, String updatedBy) {
    ...
    public Category(String id, Date createdAt, Date updatedAt, String createdBy, String updatedBy, String categoryName, String description, String categoryCode) {
        super(id, createdAt, updatedAt, createdBy, updatedBy);
        this.categoryName = categoryName;
        this.description = description;
        this.categoryCode = categoryCode;
