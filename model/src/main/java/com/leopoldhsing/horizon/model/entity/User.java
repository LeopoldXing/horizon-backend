...
public class User extends BaseEntity {
    ...
    public User(String id, Date createdAt, Date updatedAt, String createdBy, String updatedBy) {
    ...
    public User(String id, Date createdAt, Date updatedAt, String createdBy, String updatedBy, String firstName, String lastName, String email, String address, String city, String postalCode, Date dateOfBirth, String ssn, String state, String dwollaCustomerId) {
        super(id, createdAt, updatedAt, createdBy, updatedBy);
        this.firstName = firstName;
        this.lastName = lastName;
        this.email = email;
