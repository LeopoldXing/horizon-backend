CREATE DATABASE IF NOT EXISTS `horizon` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */ /*!80016 DEFAULT ENCRYPTION = 'N' */;
...
CREATE TABLE IF NOT EXISTS `plaid_customers`
(
    `id`               bigint NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `dwolla_customer`
(
    `id`                  bigint NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `link_bank_country_code`
(
    `id`               bigint NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `link_transaction_category`
(
